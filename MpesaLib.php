...
define("MPESA_CONSUMER_KEY", "mAbzG8t0PQXnyBmZNsCqPyUovnTC9W1c");
define("MPESA_CONSUMER_SECRET", "GO1HVqoeA3FAOGrH");
...
define('CallBackURL', 'https://google.com');
...
class Mpesa
{
    ...
    public static function STKPushQuery($environment, $checkoutRequestID, $businessShortCode){
        ...
        $password = Mpesa::getPassword($businessShortCode, MPES_PASSKEY, $timestamp);
        try {
            $environment = MPESA_ENV;
        } catch (\Throwable $th) {
            $environment = MPESA_ENV;
